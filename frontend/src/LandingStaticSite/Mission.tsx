        ...
        <Box bg={'white.50'} color="text" py={12} position="relative" overflow="hidden">
            ...
            <Container maxW="7xl" py={12} position="relative" zIndex={1}>
                <Flex direction={{ base: 'column', md: 'row' }} align="center" gap={8}>
                    ...
                    {/* Text */}
                    <Box flex={1}>
                        <Heading size="xl" mb={4} bgGradient="linear(to-r, secondary.400, primary.500)" bgClip="text">
                            The Teacher Shortage Crisis
                        </Heading>
                        <Text fontSize="lg" color={useColorModeValue('gray.600', 'gray.300')}>
                            Growing up in Canada, we experienced firsthand the impact of the teacher shortage. There were weeks when our classes had no teachers, leaving students without guidance and falling behind. We saw how overworked and stressed our teachers were, trying to manage large classes with limited resources.
                        </Text>
                    </Box>
                </Flex>
            </Container>
            ...
            <Container maxW="7xl" py={12} position="relative" zIndex={1}>
                <Flex direction={{ base: 'column', md: 'row-reverse' }} align="center" gap={8}>
                    ...
                    <Box flex={1} animation={floatAnimation}>
                        <Image
                            src="/stressed_teacher.png" // Replace with your image
                    ...
                    <Box flex={1}>
                        ...
                        <Text fontSize="lg" color={useColorModeValue('gray.600', 'gray.300')}>
                            Our teachers were heroes, but even heroes have limits. They struggled to keep up with grading, lesson planning, and supporting students—all while managing overcrowded classrooms. We knew there had to be a better way to support them.
                        </Text>
                    </Box>
                </Flex>
            </Container>
            ...
            <Container maxW="7xl" py={12} position="relative" zIndex={1}>
                <Flex direction={{ base: 'column', md: 'row' }} align="center" gap={8}>
                    ...
                    <Box flex={1}>
                        ...
                        <Text fontSize="lg" color={useColorModeValue('gray.600', 'gray.300')}>
                            EduTrack was born out of a desire to make teachers' lives easier. By simplifying assignment tracking, providing student insights, and automating repetitive tasks, we aim to give teachers more time to focus on what they do best: teaching. Our mission is to empower teachers and ensure no student gets left behind.
                        </Text>
                    </Box>
                </Flex>
            </Container>
